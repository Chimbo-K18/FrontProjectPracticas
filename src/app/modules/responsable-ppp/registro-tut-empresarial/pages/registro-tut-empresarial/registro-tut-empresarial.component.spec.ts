...
export class RegistroTutEmpresarialComponent {
  ...
  ngOnInit(): void {
    this.personasemp = new personasemp();
  ...
  crearpersonaemp() {
    this.personaempService
      ...
      .subscribe((response) => {
        ...
        console.log(
          'Exito al Registrar persona empresa',
          this.idpersonaempresa
        );
        this.copy_address();
        Swal.fire({
          position: 'top',
  ...
  obtenerempresacreada(idEmpresa: any) {
    this.empresaService.getPorId(idEmpresa).subscribe((data) => {
      //  this.empresa = data;
  ...
  obtenerUsuariocreado(idUsuario: any) {
    this.userService.getUsuarioporId(idUsuario).subscribe((data) => {
      // this.usuarios = data;
  ...
  crearusuario() {
    ...
    this.CreateAccountService.createUserempresa(this.usuarios).subscribe(
      (response) => {
